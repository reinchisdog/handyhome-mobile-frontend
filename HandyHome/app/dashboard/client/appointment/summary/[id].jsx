...
import { StyleSheet, Text, View, ScrollView, useWindowDimensions, Pressable, Image, ImageBackground, Modal, StatusBar } from 'react-native';
...
const AppointmentSummaryScreen = () => {
   ...
   const { summary, summaryLoading, fetchSummary, rejectAppointment, fetchNewWorker, confirmAppointment, confirmLoading, } = useAppointment();
