         ...
         style={[global.screenContainer, {backgroundColor: '#fff'}]}>
            ...
            imageStyle={{
               ...
               style={{
                  ...
                  <TouchableOpacity
                  onPress={() => {router.push('/dashboard/client/settings/edit')}}
                  style={{
                     height: '100%',
            ...
            style={{
               ...
               <ProfileTab 
               onPress={() => {router.push('/dashboard/client/settings/account')}}
               ...
               <ProfileTab 
               onPress={() => {router.push('/dashboard/client/settings/terms')}}
               ...
               {/* Privacy Policy */}
               <ProfileTab 
               onPress={() => {router.push('/dashboard/client/settings/policies')}}
               ...
               {/* About Us */}
               <ProfileTab 
               onPress={() => {router.push('/dashboard/client/settings/about')}}
               icon={<Icons2 name="key" size={24} color={COLORS.primary} />}
               title="About Us"
               />
