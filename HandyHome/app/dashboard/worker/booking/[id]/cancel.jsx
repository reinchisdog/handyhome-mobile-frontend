...
const WorkerBookingCancel = () => {
   ...
   const cancelOptions = [
      ...
      {label: 'Equipment or Materials Issue', value: 'Equipment or Materials Issue'},
      {label: 'Conflict in Scheduling', value: 'Conflict in Scheduling'},
      {label: 'Unable to Contact Client', value: 'Unable to Contact Client'},
      {label: 'Unsafe Work Environment', value: 'Unsafe Work Environment'},
   ...
   const handleCancel = async () => {
      try {
         ...
         await api.post(`/worker/bookings/${id}/cancel`, reasonObject, {
            headers: {
         ...
         >
            ...
            style={{
               ...
               <View style={global.centerModal}>
                  ...
                  onPress={() => router.replace('/dashboard/worker/bookings/cancelled')}
                  />
               </View>
            </View>
         </Modal>
...
export default WorkerBookingCancel
